...
while True:
    ...
    if current - last_print >= 1.0:
        ...
        if gps.height_geoid is not None:
            ...
            print("Position in ECEF: ", GPS2ECEF(gps.latitude, gps.longitude, gps.altitude_m))
            print("\n")
            origin_ECEF, _ = GPS2ECEF(gps.latitude, gps.longitude, gps.altitude_m, 1)
            print("Position in ENU: ", GPS2ENU(gps.latitude, gps.longitude, gps.altitude_m, origin_ECEF))
            print("\n")
